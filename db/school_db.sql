...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1618219437ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school_db&table=schools">`school_db`.`schools`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=questions_db&table=questions1">`questions_db`.`questions1`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=questions_db&table=questions">`questions_db`.`questions`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7a4063313d32444d4639496c2b315b7e">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="school_db" targettable="schools">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `schools`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="school_db" targettable="schools">
                            <div class="action_content">
